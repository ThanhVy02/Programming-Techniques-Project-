...
#         self.customerManagementWindow = QMainWindow()
#         self.uiCustomerManagement = Ui_CustomerManagement()
#         self.uiCustomerManagement.setupUi(self.customerManagementWindow)
#
#         # Hiển thị danh sách khách hàng từ dataset
#         self.display_customer_list()
#
#         # Kết nối các nút chức năng (nếu cần)
#         self.uiCustomerManagement.pushButtonSearch.clicked.connect(self.search_customer)
#         self.uiCustomerManagement.pushButtonEdit.clicked.connect(self.edit_customer)
#         self.uiCustomerManagement.pushButtonRemove.clicked.connect(self.remove_customer)
#         self.uiCustomerManagement.pushButtonAdd.clicked.connect(self.add_customer)
#
#         self.customerManagementWindow.show()
#
#     def load_customer_list(self):
#         """Hiển thị danh sách khách hàng từ file customers.json."""
#         customers_path = "../dataset/customers.json"
#         try:
#             with open(customers_path, "r", encoding="utf-8") as file:
#                 customers = json.load(file)
#         except (FileNotFoundError, json.JSONDecodeError):
#             QMessageBox.warning(self, "Lỗi", "Không thể tải danh sách khách hàng.")
#             return
#         self.ui.listWidgetCustomers.clear()
#         for customer in customers:
#             self.ui.listWidgetCustomers.addItem(QListWidgetItem(f"{customer['full_name']} | {customer['phone']}"))
#
#     def search_customer(self):
#         """Tìm kiếm khách hàng theo số điện thoại."""
#         search_phone = self.ui.lineEditSearchPhone.text().strip()
#         if not search_phone:
...
#             return
#         for customer in customers:
#             if customer["phone"] == search_phone:
#                 QMessageBox.information(self, "Kết quả", f"Họ tên: {customer['full_name']} | SĐT: {customer['phone']}")
#                 return
#         QMessageBox.warning(self, "Không tìm thấy", "Không tìm thấy khách hàng.")
#
#     def add_customer(self):
#         """Thêm khách hàng mới vào file customers.json."""
#         full_name = self.ui.lineEditFullName.text().strip()
#         phone_number = self.ui.lineEditPhone.text().strip()
#         if not full_name or not phone_number:
...
#         except:
#             customers = []
#         if any(customer["phone"] == phone_number for customer in customers):
#             QMessageBox.warning(self, "Trùng lặp", "Khách hàng đã tồn tại.")
#             return
#         customers.append({"full_name": full_name, "phone": phone_number})
...
#         delete_phone = self.ui.lineEditSearchPhone.text().strip()
#         if not delete_phone:
#             QMessageBox.warning(self, "Lỗi", "Vui lòng nhập số điện thoại để xóa.")
#             return
#         customers_path = "../dataset/customers.json"
#         try:
#             with open(customers_path, "r", encoding="utf-8") as file:
...
#             QMessageBox.warning(self, "Lỗi", "Không thể tải danh sách khách hàng.")
#             return
#         updated_customers = [customer for customer in customers if customer["phone"] != delete_phone]
#         if len(updated_customers) == len(customers):
#             QMessageBox.warning(self, "Không tìm thấy", "Không tìm thấy khách hàng để xóa.")
#             return
#         with open(customers_path, "w", encoding="utf-8") as file:
...
#         """Chỉnh sửa thông tin khách hàng trong file customers.json."""
#         edit_phone = self.ui.lineEditSearchPhone.text().strip()
#         new_full_name = self.ui.lineEditFullName.text().strip()
#         new_phone_number = self.ui.lineEditPhone.text().strip()
#         if not edit_phone or not new_full_name or not new_phone_number:
#             QMessageBox.warning(self, "Lỗi", "Vui lòng nhập đầy đủ thông tin.")
#             return
#         customers_path = "../dataset/customers.json"
#         try:
...
#             return
#         for customer in customers:
#             if customer["phone"] == edit_phone:
#                 customer["full_name"] = new_full_name
#                 customer["phone"] = new_phone_number
#                 with open(customers_path, "w", encoding="utf-8") as file:
#                     json.dump(customers, file, indent=4, ensure_ascii=False)
#                 QMessageBox.information(self, "Thành công", "Chỉnh sửa thông tin khách hàng thành công.")
#                 self.load_customer_list()
#                 return
#         QMessageBox.warning(self, "Không tìm thấy", "Không tìm thấy khách hàng để chỉnh sửa.")